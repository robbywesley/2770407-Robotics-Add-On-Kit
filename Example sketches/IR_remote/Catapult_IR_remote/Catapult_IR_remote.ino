...
// * Version            : V1.0
// * Date               : 2014/01/23
// * Description        : Use the RadioShack Robotics Remote Control to control the catapult robot.
//********************************************************************************
...
RadioShackRobotics catapult; //declare object
// *************************************************************************
// *                            Power Up Init.
// *************************************************************************
void setup() 
...
{
  catapult.remote_scan();  //analyze signal from RadioShack Robotics Remote Control
}
