...
// * Version            : V1.0
// * Date               : 2014/01/24
// * Description        : Use the RadioShack Robotics Remote Control to control the street sweeper robot.
// ********************************************************************************
...
{
  street_sweeper.remote_scan();  //analyze signal from RadioShack Robotics Remote Control
}
