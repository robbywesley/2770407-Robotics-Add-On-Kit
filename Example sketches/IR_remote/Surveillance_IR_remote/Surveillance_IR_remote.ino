...
// * Version            : V1.0
// * Date               : 2014/01/23
// * Description        : Use the RadioShack Robotics Remote Control to control the surveillance robot.
// ********************************************************************************
...
*****************************************************************************/
#include <RadioShackRobotics.h> //install library
RadioShackRobotics surveillance; //declare object
// **************************************************************************
// *                            Power Up Init.
// **************************************************************************
void setup() 
...
{
  surveillance.remote_scan();  //analyze signal from RadioShack Robotics Remote Control
}
