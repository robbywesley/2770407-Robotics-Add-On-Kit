...
// * Version            : V1.0
// * Date               : 2014/01/24
// * Description        : Use the RadioShack Robotics Remote Control to control the spotlight robot.
// ********************************************************************************
...
RadioShackRobotics spotlight; //declare object
// ***************************************************************************
// *                            Power Up Init.
// ***************************************************************************
void setup() 
...
{
  spotlight.remote_scan(); //analyze signal from RadioShack Robotics Remote Control
}
